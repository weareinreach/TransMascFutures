...
export const stories: Prisma.StoryCreateManyInput[] = [
	...
	},
	{
		...
		response1ES:
			"Nunca vi mi futuro como hombre trans. Vi mi futuro como hombre.",
		response2ES:
	...
	},
	{
		...
		response2EN:
			"Community therapy chosen family and gender affirming healthcare.",
		response1ES:
		...
		response2ES:
			"Comunidad, terapia, familia elegida y cuidado de la salud género afirmante.",
	},
	{
	...
	},
	{
		...
		response2EN:
			"Google YouTube TikTok fellow trans men and Planned Parenthood.",
		response1ES:
	...
	},
	{
		...
		response2EN:
			"Queer youth programs and camps in my state my friends and my university doctors",
		response1ES:
	...
	},
	{
		...
		name: "Maxl",
		response1EN:
			"If I had known at the time I was supposed to remember it I would have.",
		response2EN:
		...
		response1ES:
			"Si hubiera sabido en ese momento que debía recordarlo, lo habría hecho.",
		response2ES:
	...
	},
	{
		...
		response2EN:
			"Different social media accounts of FTM people the trace app and YouTube videos.",
	...
	},
	{
		...
		response2EN:
			"Social media Stand with Trans' Ally Parents program and my therapist.",
		response1ES:
	...
	},
	{
		...
		response2EN:
			"I think top surgery definitely helped make me feel more at home in myself.",
		response1ES:
		...
		response2ES:
			"Creo que la mastectomía definitivamente me ayudó a sentirme más a gusto conmigo misme.",
	},
	{
	...
	},
	{
		...
		response2EN:
			"Callen Lorde Medical Center in NYC was instrumental in helping me transition safely.",
		response1ES:
			"Encontrar historias en línea a través de Tumblr, Instagram o DeviantART me ayudó a encontrar comunidad y consuelo. También he tenido un amigo trans masculino en mi vida que ya había comenzado a transicionar antes de conocerlo. Cuando me di cuenta de que ambos éramos trans, solo que en diferentes etapas, me dio mucha confianza.",
		response2ES:
	...
	},
	{
		...
		name: "Krystiano",
		response1EN:
			"When I first did all of my research and realized that I am a trans man.",
		response2EN: "Taking testosterone and my partner.",
		response1ES:
			"Empecé a investigar y me di cuenta de que soy un hombre trans.",
	...
	},
	{
		...
		response1ES:
			"Cuando me fui de una universidad para solamente mujeres a una universidad mixta.",
		response2ES:
