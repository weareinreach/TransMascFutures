...
const AboutPage = () => {
	...
	return (
		<>
			<Head>
				<title>
					{t("page-title.general-template", { page: "$t(nav.about)" })}
				</title>
			</Head>
			...
			<Container>
				...
				>
					<Group className={classes.statistics}>
						<StatisticCard
							title={t("about.stats.stat1-title")}
							text={t("about.stats.stat1-text")}
						/>
						<StatisticCard
							title={t("about.stats.stat2-title")}
							text={t("about.stats.stat2-text")}
						/>
						<StatisticCard
							title={t("about.stats.stat3-title")}
							text={t("about.stats.stat3-text")}
						/>
					</Group>
					<Text
						fz={{ md: "lg" }}
			...
			<Divider
				size={10}
				color={theme.other.colors.glaadGray}
				my={40}
				mx={{ lg: 80, base: 15, xs: 40 }}
			/>
			<Flex direction="column" align="center" w="100%">
					...
					components={{
						Title: (
							<Text
								my={40}
								ta="center"
								mx={{ lg: 0, base: 10, xs: 50, [em(450)]: 60 }}
								fw={500}
								fz={20}
							>
								.
				...
				<Center>
					<AspectRatio
						ratio={
							partnerImages.hollister.width / partnerImages.hollister.height
						}
