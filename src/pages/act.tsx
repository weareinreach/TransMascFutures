...
export const Act: NextPage = () => {
	...
	return (
		<Container fluid p={"xl"}>
			<Head>
				<title>
					{t("page-title.general-template", { page: "$t(nav.act)" })}
				</title>
			</Head>
					...
					<Center>
						<Card maw={450} h="100%">
							<Card.Section>
								<Center h={400}>
									<AspectRatio
										ratio={ParticipateImage.width / ParticipateImage.height}
										w={400}
									>
					...
					<Center>
						<Card maw={450}>
							<Card.Section>
								<Center h={400}>
									<AspectRatio
										ratio={SuggestImage.width / SuggestImage.height}
										w={300}
										h={400}
									>
					...
					<Center>
						<Card maw={450}>
							<Card.Section>
								<Center h={400}>
									<AspectRatio
										ratio={AppImage.width / AppImage.height}
										w={200}
										h={400}
									>
