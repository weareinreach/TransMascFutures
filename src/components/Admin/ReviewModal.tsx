					...
					<Grid>
						...
						<Grid.Col span={6}>
							...
							<ScrollArea h={200} type='auto' offsetScrollbars>
								...
								<Text mb='md' color={data.crowdin.response1 ? 'black' : 'red'}>
									{data.crowdin.response1 || 'Translation pending...'}
								</Text>
								<Text size='sm' color='dimmed' mb='xs'>
									Respuesta 2
								</Text>
								<Text color={data.crowdin.response2 ? 'black' : 'red'}>
									{data.crowdin.response2 || 'Translation pending...'}
								</Text>
							</ScrollArea>
						</Grid.Col>
					</Grid>
