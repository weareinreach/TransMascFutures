...
- **`src/components`**: Reusable UI components.
  - _Rule_: If a component is complex, give it its own folder with a `.stories.tsx` file.
...
_Note: Spanish translations are handled via the Crowdin workflow (see `crowdin-workflow.md`)._
